...
public interface Storage {
     ...
     * @throws StorageException
     */
    <T extends Entity> void save(T entity) throws StorageException, NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException;
}